...
import com.javen.weixin.controller.*;
...
public class APPConfig extends JFinalConfig {
	...
	public void configRoute(Routes me) {
		// 微信
		me.add("/vuecli", VueTestController.class, "vue_cli");
		me.add("/wechatsite", WechatInterfaceController.class, "/wechat_site");
