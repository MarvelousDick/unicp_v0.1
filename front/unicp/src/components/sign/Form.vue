...
<script>
  ...
  import {required, maxLength, email, minLength, between, numeric} from 'vuelidate/lib/validators'
  ...
  export default {
    ...
    mounted() {
      popUp: {
        ...
        // this.$http.get('http://192.168.2.216:3000/wechatsite/getinfo')
        this.$http({
          method: 'post',
